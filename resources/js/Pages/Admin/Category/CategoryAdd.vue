  ...
  <div>
    ...
    <form @submit.prevent="addCategory">
      <div>
        ...
        <input type="text" id="name" v-model="categoryName" class="form-control" placeholder="Nhập tên danh mục" />
      </div>
      <div>
...
const getParentCategories = async () => {
  const { data } = await AdminApi.get('/parentCategories');
...
const addCategory = async () => {
  try {
    ...
    const response = await AdminApi.post("/categories", { name: categoryName.value, parent_id: parentId.value });
